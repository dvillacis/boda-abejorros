...
OverlayLoader.prototype.createOverlay = function () {
	...
	//GCC
		...
		var BigDay = new Date("5 Sept 2015, 10:30:00");
		...
		window.setInterval(function(){
			...
			/*var timeString = "<div class='counter'><div class='daysleft'>" + daysLeft + "</div><h5>Days</h5></div>" + 
	...
	//GCC - create the timer
	this.timer = $("<div id='timer'></div>").css({
